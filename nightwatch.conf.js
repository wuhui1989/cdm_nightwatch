...
const config = { // we use a nightwatch.conf.js file so we can include comments and helper functions
  ...
  "selenium": {
    "start_process": true, //Whether or not to manage the Selenium process automatically.
    "server_path": seleniumServer.path, //The location of the Selenium jar file. This needs to be specified if start_process is enabled.
    "log_path": "", //The location where the Selenium output.log file will be placed. Defaults to current directory.
    "host": "127.0.0.1",
    "port": 4444, //The port number Selenium will listen on and/or Nighwatch will attempt to connect to.
    "cli_args": {
...
module.exports.baseUrl = "https://test.com:18081"
